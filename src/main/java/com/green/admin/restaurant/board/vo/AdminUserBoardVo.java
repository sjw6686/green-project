package com.green.admin.restaurant.board.vo;

public class AdminUserBoardVo {
	...
	//constructor
	public AdminUserBoardVo() {}
	
	public AdminUserBoardVo(int board_idx, int board_type, String board_title, String board_content, int review_avg,
