...
public class OwnerRestaurantMenuFileJoinVo {
	...
	public String toString() {
		return "RestaurantMenuFileVo [restaurant_idx=" + restaurant_idx + ", brand_name=" + brand_name + ", address="
				...
				+ ", menu_name=" + menu_name + ", menu_price=" + menu_price + ", file_idx=" + file_idx + ", file_name="
				+ file_name + ", file_ext=" + file_ext + ", sfile_name=" + sfile_name + "]";
	}
